...
static void createModuleCodeObjects(void) {
    ...
    codeobj_67bcc9beaa8e3430dd944c933c2f61a5 = MAKE_CODEOBJECT(module_filename_obj, 1, CO_NOFREE, mod_consts[26], NULL, NULL, 0, 0, 0);
}
...
// Mark the execution in the "__spec__" value.
    ...
    tmp_res = PyDict_DelItem((PyObject *)moduledict_gi$repository, mod_consts[21]);
    ...
    tmp_res = PyDict_DelItem((PyObject *)moduledict_gi$repository, mod_consts[17]);
    tmp_result = tmp_res != -1;
    if (tmp_result == false) CLEAR_ERROR_OCCURRED();
